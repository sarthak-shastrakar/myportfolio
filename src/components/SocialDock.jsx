...
import { GithubIcon as Github, LinkedinIcon as Linkedin, NaukriIcon as Naukri } from './icons';

const socialLinks = [
  { icon: Github, label: "GitHub", href: "https://github.com/sarthak-shastrakar" },
  { icon: Linkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/sarthak-fullstack-developer/" },
  { icon: Mail, label: "Email", href: "mailto:sarthakshastrakar@gmail.com" },
  { icon: Naukri, label: "Naukri", href: "https://www.naukri.com/mnjuser/profile?id=&altresid" },
  { icon: Phone, label: "Phone", href: "tel:+918767901968" },
];
